...
#define BT1 34  // channels
#define BT2 33  // jamming
#define BT3 32  // data rate
#define BT4 35  // PA level
#endif
...
void jammerLoop() {
  while (true) {
    ...
    if (digitalRead(BUTTON_BACK_PIN) == LOW && digitalRead(BUTTON_DOWN_PIN) == LOW) {
      setNeoPixelColour("off");
      break;
    }
  }
